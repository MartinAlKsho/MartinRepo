...
namespace MAPatients.Models
{
    public partial class PatientsContext : DbContext
    {
        ...
        public virtual DbSet<ConcentrationUnitNew> ConcentrationUnitNew { get; set; }
...
//            }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ConcentrationUnitNew>(entity =>
            {
                entity.ToTable("concentrationUnit_new");

                entity.HasIndex(e => e.ConcentrationCode)
                    .HasName("IX_temp")
                    .IsUnique();
